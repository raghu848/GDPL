    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 items-start border-t border-black/5">
                    ...
                    <div className="flex flex-col lg:col-span-5 lg:pr-12 lg:sticky lg:top-[12.5vh] lg:h-[75vh] lg:justify-between lg:py-4">
                        ...
                        <div className="mt-8 flex justify-start">
                            ...
                            >
                                Full Portfolio
                                <div className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center group-hover:bg-noir group-hover:text-white transition-all">
    ...
    return (
        <div className="relative border-b border-black/5 group">
            ...
            >
                ...
                <p className="text-sm font-medium leading-relaxed text-noir/60 mb-6 lg:hidden line-clamp-2">
                    {project.tagline}
                </p>
                ...
                <div className="lg:hidden mt-0 relative aspect-video rounded-2xl overflow-hidden border border-black/5">
                    <Image
