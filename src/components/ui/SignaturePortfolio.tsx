...
export default function SignaturePortfolio() {
    ...
    return (
        <section
            ref={containerRef}
            className="py-16 md:py-24 bg-transparent relative overflow-hidden signature-portfolio-section"
        >
            ...
            <div className="container mx-auto px-6 mb-12 md:mb-16">
                ...
                <motion.div style={{ x: translateX, opacity }} className="hidden md:block">
                    <p className="section-label mb-4 font-archivo tracking-tight">Our Portfolio</p>
                    <h2 className="text-4xl md:text-7xl font-normal capitalize tracking-normal leading-[0.9] text-white font-serif">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 items-start border-t border-white/5">
                    ...
                    <div className="flex flex-col lg:col-span-5 lg:pr-12 lg:sticky lg:top-[12.5vh] lg:h-[75vh] lg:justify-between lg:py-4">
                        ...
                        <div className="mt-8 flex justify-start">
                            <Link
                                href="/projects"
                                className="group flex items-center gap-4 text-xs font-archivo capitalize tracking-tight text-white/40 hover:text-white transition-colors"
                            >
                                Full Portfolio
                            ...
                            >
                                ...
                                <div className="absolute bottom-12 left-12 right-12">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <span className="text-[12px] font-archivo capitalize tracking-tight text-white/80">
                                            {project.location}
                                        </span>
                                    </div>
                                    <h4 className="text-5xl font-archivo text-white capitalize tracking-tight leading-none mb-4">
                                        {project.name}
                                    </h4>
                                    <p className="text-white/40 text-[12px] font-archivo capitalize tracking-tight">
                                        {project.status}
                                    </p>
                                </div>
                            </motion.div>
...
function ProjectItem({
    ...
    return (
        <div className="relative border-b border-white/5 group">
            ...
            >
                <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-archivo capitalize tracking-tight leading-none flex items-center gap-4 mb-4 whitespace-nowrap">
                    {project.name}
                ...
                {project.tagline && (
                    <p 
                        className="text-[14px] leading-relaxed text-white/60 mb-6 lg:hidden line-clamp-2 tracking-tight"
                        style={{ fontFamily: 'var(--font-archivo), "Archivo Black", sans-serif' }}
                    >
                        {project.tagline}
                    </p>
                )}
                ...
                {project.tagline && (
                    <p 
                        className={cn(
                            "hidden lg:block text-[14px] leading-relaxed max-w-xl transition-all duration-500 line-clamp-2 tracking-tight",
                ...
                <div className="lg:hidden mt-0 relative aspect-video rounded-2xl overflow-hidden border border-white/5">
                    ...
                    <div className="absolute bottom-4 left-4 p-2">
                        <p className="text-[10px] font-archivo capitalize tracking-tight text-white/60 mb-1">{project.location}</p>
